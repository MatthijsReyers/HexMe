...
OBJECTS = $(OBJECTFOLDER)argparse.o $(OBJECTFOLDER)exceptions.o $(OBJECTFOLDER)file.o $(OBJECTFOLDER)hdetect.o $(OBJECTFOLDER)commandline.o $(OBJECTFOLDER)main.o $(OBJECTFOLDER)app.o $(OBJECTFOLDER)settings.o 

main: exceptions settings argparse file hdetect commandline maingui app
